 ...
 * necessarily be an absolute or relative path to a file, but may be a Rollup Virtual Module.
...
export const loaderPlugin = (entries: { [id: string]: string } = {}): Plugin => {
  return {
    ...
    /**
     * A rollup build hook for resolving the imports of individual Stencil project files
